...
function Wallet() {
    ...
    const connec9tToMetamask = async () => {
        try {
            ...
            const followContract = new web3Instance.eth.Contract(followContractABI, followContractAddress);
            const postContract = new web3Instance.eth.Contract(postContractABI, postContractAddress);
        ...
        <>
            <div className="navbar bg-base-100">
                <div className="flex-1">
                    <Link href="/" className="btn btn-ghost normal-case text-xl">Turtl</Link>
                </div>
            </div>
            <div className=" h-[91vh] flex flex-col justify-center items-center ">

                <div className="w-full  mt-40 max-w-sm p-4 bg-white border border-gray-200 rounded-lg shadow sm:p-6 dark:bg-gray-800 dark:border-gray-700">
                    ...
                    <div className="my-4 space-y-3">
                        ...
                        <div onClick={connectToMetamask} className="flex items-center cursor-pointer p-3 text-base font-bold text-gray-900 rounded-lg bg-gray-50 hover:bg-gray-100 group hover:shadow dark:bg-gray-600 dark:hover:bg-gray-500 dark:text-white">
